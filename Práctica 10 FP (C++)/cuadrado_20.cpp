...
class Cuadrado{
	...
	public:
		...
		void setEsquina(double abcisa, double ordenada){
			x = abcisa;
			y = ordenada;
		}
		void setLado(double lado_cu){
			lado = lado_cu;
		}
};
...
int main(){  
   ...
   cin >> long_parcela;
	...
	parcela.setEsquina(esquina_x, esquina_y);
   ...
   cin >> long_parcela;
	...
	otra_parcela.setEsquina(esquina_x, esquina_y);
